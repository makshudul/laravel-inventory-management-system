...
<nav class="breadcrumb pd-0 mg-0 tx-12">
    ...
    <a class="breadcrumb-item" href="#">Monthly Income</a>
    <span class="breadcrumb-item active text-success">Monthly Income</span>
  </nav>
  @endsection
@section('content')
@php
...
@endphp
                    ...
                    <h1 class=" text-center text-info font-weight-bold ">Monthly income Deteils</h1>
                   <hr class="bg-info mb-4">
                 <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-center text-info ">Monthly Sales</h3>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-center text-info ">Monthly Purchase</h3>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-center text-info ">Monthly Other Cost</h3>
                            </div>
                            <div class="card-body">
                 ...
                 <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                <div class="col-md-4">
                                    <h5 class="text-center text-success">Monthly Sales Amount</h5>
                                ...
                                <div class="col-md-4">
                                    <h5 class="text-center text-success">Monthly Purchase Amount</h5>
                                ...
                                <div class="col-md-4">
                                    <h5 class="text-center text-success">Monthly Cost Amount</h5>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="text-info text-center">Monthly Total Income </h2>
                            </div>
                            @php
